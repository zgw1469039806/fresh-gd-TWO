...
public class GdReplenishController {
    ...
    @PostMapping("/delGdReplen")
    public ResponseData<Integer> delGdReplen(@RequestBody RequestData<Integer> requestData) {
        return gdReplenishFeginService.delReplenishById(requestData);
    }
}
